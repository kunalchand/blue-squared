...
class TestGetSingleRecord(BaseTestCase):
    def test_get_records_single_id_valid(self):
        ...
        self.assertEqual(table2_data['name'], 'Liam Turner')
        self.assertEqual(table2_data['gender'], 'Male')
        self.assertEqual(table2_data['height'], 170)
        self.assertEqual(table2_data['city'], 'Houston')
